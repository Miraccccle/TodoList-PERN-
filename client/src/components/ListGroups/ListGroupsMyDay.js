...
const ListGroupsMyDay = ({group, getGroup}) => {
    ...
    return (
      <>
        <div className="group">
        <ListHeaderFold listName={group.name} getData={getData} group_id={group.id} group={group} getGroup={getGroup}/>
...
export default ListGroupsMyDay;
